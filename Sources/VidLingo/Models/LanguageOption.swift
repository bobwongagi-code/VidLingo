...
struct LanguageOption: Identifiable, Hashable, Sendable {
    ...
    static let supported: [LanguageOption] = [
        ...
        .init(id: "th-TH", title: "Thai", locale: Locale(identifier: "th-TH")),
        .init(id: "ms-MY", title: "Malay", locale: Locale(identifier: "ms-MY")),
        .init(id: "id-ID", title: "Indonesian", locale: Locale(identifier: "id-ID")),
